...
def kmeans_compress(image_array,k=16,max_iterations=100):
    ...
    for i in range(k):
        ...
        if len(cluster_pixels) == 0:
            ...
            # 作为代表色
            vivid_color = cluster_pixels[max_brightness_idx]
...
if __name__ == '__main__':
    print("使用max:Luminosity压缩")
    input_image = 'ao.jpg'
    output_images = [
        './compress_lu_max/2.jpg',
        './compress_lu_max/4.jpg',
        './compress_lu_max/8.jpg',
        './compress_lu_max/16.jpg',
        './compress_lu_max/24.jpg',
        './compress_lu_max/32.jpg',
        './compress_lu_max/64.jpg',
    ]
