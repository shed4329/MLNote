...
def kmeans_compress(image_array,k=16,max_iterations=100):
    ...
    for i in range(k):
        ...
        if len(cluster_pixels) == 0:
            ...
            # 找到最亮的像素
            max_score_idx = np.argmax(saturation)
            # 作为代表色
...
if __name__ == '__main__':
    print("使用max:saturation压缩")
    input_image = 'ao.jpg'
    output_images = [
        './compress_sa_max/2.jpg',
        './compress_sa_max/4.jpg',
        './compress_sa_max/8.jpg',
        './compress_sa_max/16.jpg',
        './compress_sa_max/24.jpg',
        './compress_sa_max/32.jpg',
        './compress_sa_max/64.jpg',
    ]
