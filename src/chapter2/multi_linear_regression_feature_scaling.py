...
if __name__ == '__main__':
    ...
    for i in range(iterate_times):
        tmp_w1 = w1 - partial_w1(w1, w2, b, x1_scaled, x2_scaled, y) * alpha
        tmp_w2 = w2 - partial_w2(w1, w2, b, x1_scaled, x2_scaled, y) * alpha
        tmp_b = b - partial_b(w1, w2, b, x1_scaled, x2_scaled, y) * alpha
        w1 = tmp_w1
        w2 = tmp_w2
        b = tmp_b
