...
if __name__ == '__main__':
    ...
    cost = [cost_function(w1,w2,b,x1_scaled,x2_scaled,y)]
    ...
    while (abs(delta_cost) > 0.01):
        ...
        w2 -= d_w2 * alpha
        b -= d_b * alpha
        cost.append(cost_function(w1, w2, b, x1_scaled, x2_scaled, y))
    ...
    ax2.plot(range(1, len(cost)+1), cost, 'b-', linewidth=2)
